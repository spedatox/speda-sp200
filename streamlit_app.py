...
def generate_response(user_input, user_name, messages):
    ...
    content = f"Senin adın {user_name}. Ahmet Erol Bayrak Tarafından Geliştirilen Bir Yapay Zekasın. Kod yazabilir, metin oluşturabilir, bir yapay zeka asistanının yapabildiği neredeyse herşeyi yapabilirsin"
    prompt = f"{content}\n\n{user_input}"
